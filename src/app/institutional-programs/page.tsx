          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              <Link href="/for-schools" className="block group">
                <div className="h-full rounded-2xl border border-rose-500/20 bg-gradient-to-br from-rose-500/5 to-orange-500/5 p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  <div className="w-16 h-16 rounded-xl bg-rose-500/10 text-rose-500 flex items-center justify-center mb-6">
            ...
            >
              <Link href="/for-colleges" className="block group">
                <div className="h-full rounded-2xl border border-blue-500/20 bg-gradient-to-br from-blue-500/5 to-violet-500/5 p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  <div className="w-16 h-16 rounded-xl bg-blue-500/10 text-blue-500 flex items-center justify-center mb-6">
