        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <motion.div
              ...
              className="h-full"
            >
              <Link href="/for-schools" className="block group h-full">
                <div className="h-full rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 mb-4 leading-relaxed flex-grow">
                    Emotional agility, cognitive readiness, digital ecosystem, STEM,
                    and career counselling programs designed for K-12 students.
                    Build strong foundations that last a lifetime.
                  </p>
                  <ul className="space-y-2 mb-6">
                    <li className="flex items-center gap-2 text-sm">
                      <CheckCircle className="w-4 h-4 text-blue-700 dark:text-blue-400 flex-shrink-0" />
                    ...
                    <li className="flex items-center gap-2 text-sm">
                      <CheckCircle className="w-4 h-4 text-blue-700 dark:text-blue-400 flex-shrink-0" />
                      FutureFit - Personalized Career Counselling
                    </li>
                    <li className="flex items-center gap-2 text-sm">
                      <CheckCircle className="w-4 h-4 text-blue-700 dark:text-blue-400 flex-shrink-0" />
                  ...
                  <span className="inline-flex items-center gap-2 text-sm font-semibold text-blue-700 dark:text-blue-400 group-hover:gap-3 transition-all mt-auto">
            ...
            <motion.div
              ...
              className="h-full"
            >
              <Link href="/for-colleges" className="block group h-full">
                <div className="h-full rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col">
                  <div className="w-16 h-16 rounded-xl bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 flex items-center justify-center mb-6">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 mb-4 leading-relaxed flex-grow">
                    Cognitive readiness, job readiness, career counselling,
                    internships, and project-based programs designed to make
                    graduates career-ready from day one.
                  </p>
                  <ul className="space-y-2 mb-6">
                    <li className="flex items-center gap-2 text-sm">
                      <CheckCircle className="w-4 h-4 text-blue-700 dark:text-blue-400 flex-shrink-0" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {partnershipBenefits.map((benefit, index) => {
              ...
              return (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 flex items-center justify-center mb-4">
