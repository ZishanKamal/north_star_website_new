          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              const colorClasses: Record<string, { border: string; bg: string; text: string }> = {
                orange: { border: "border-slate-200 dark:border-slate-700", bg: "bg-blue-50 dark:bg-blue-900/30", text: "text-blue-700 dark:text-blue-400" },
                blue: { border: "border-slate-200 dark:border-slate-700", bg: "bg-blue-50 dark:bg-blue-900/30", text: "text-blue-700 dark:text-blue-400" },
                violet: { border: "border-slate-200 dark:border-slate-700", bg: "bg-blue-50 dark:bg-blue-900/30", text: "text-blue-700 dark:text-blue-400" },
              };
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                  className={`bg-white dark:bg-slate-800 rounded-xl border ${colors.border} p-6 hover:shadow-md transition-shadow`}
                >
                  ...
                  <h3 className="font-bold text-lg mb-2 text-slate-900 dark:text-white">{caseStudy.program}</h3>
